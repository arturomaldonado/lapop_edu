...
lapop <- subset(lapop, pais<=35 & wave==2018)
```
...
```{r}
lapop$fb_user <- ifelse(lapop$smedia1==1 & lapop$smedia2<=4, 1, 0)
prop.table(table(lapop$fb_user))
lapop$tw_user <- ifelse(lapop$smedia4==1 & lapop$smedia5<=4, 1, 0)
prop.table(table(lapop$tw_user))
lapop$wa_user <- ifelse(lapop$smedia7==1 & lapop$smedia8<=4, 1, 0)
prop.table(table(lapop$wa_user))
```
