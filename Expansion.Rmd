...
Este documento describe tres escenarios de usos de factores de expansión:
...
Con este dataframe se puede calcular la distribución del apoyo a la democracia en estos dos países y se puede reportar los porcentajes redondeado.
...
La Nota Metodológica incluye un apéndice con el código en STATA para usar los factores de expansión en los datos del Barómetro de las Américas. Aquí haremos lo mismo en R, para lo cual usaremos el comando `svydesign` (similar al comando svyset en STATA).
